...
#         headers = {'content-type': 'application/json'}
#         with app.test_client() as c:
#             result =c.post('/api/v1/users/login',data=json.dumps(self.noemailds),headers=headers)
#         self.assertEqual(result.status_code,400)

#     def test_invalid_email(self):        
#         headers = {'content-type': 'application/json'}
#         with app.test_client() as c:
#             result =c.post('/api/v1/users/login',data=json.dumps(self.invalidemailds),headers=headers)
#         self.assertEqual(result.status_code,400)

#     def test_no_ps(self):        
#         headers = {'content-type': 'application/json'}
#         with app.test_client() as c:
#             result =c.post('/api/v1/users/login',data=json.dumps(self.nopsds),headers=headers)
#         self.assertEqual(result.status_code,400)

#     def test_short_ps(self):        
#         headers = {'content-type': 'application/json'}
#         with app.test_client() as c:
#             result =c.post('/api/v1/users/login',data=json.dumps(self.shortpsds),headers=headers)
#         self.assertEqual(result.status_code,400)

#     def test_wrong_ps(self):        
#         headers = {'content-type': 'application/json'}
#         with app.test_client() as c:
#             result =c.post('/api/v1/users/login',data=json.dumps(self.wrongpsds),headers=headers)
#         self.assertEqual(result.status_code,400)

#     def test_unreg_email(self):        
#         headers = {'content-type': 'application/json'}
#         with app.test_client() as c:
#             result =c.post('/api/v1/users/login',data=json.dumps(self.unregisteredemail),headers=headers)
#         self.assertEqual(result.status_code,400)
